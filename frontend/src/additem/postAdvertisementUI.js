...
class postAdvertisementUI extends React.Component {
  ...
  makePayment = () => {
    ...
    // this.props.value = {empty:'h1'})
      // this.props.history.push('/payment')
    //

  };
  PostAdvertisementCallBack =()=>{
  ...
  render() {
    return (
      <div class="container my-3 ">
        ...
        <button type="submit" class="btn btn-primary float-right " style={{ width: "200px" }} onClick={this.makePayment}>Submit</button>
        <Payment ref={this.myRef} funcallback={this.PostAdvertisementCallBack} />
      </div>
...
export default postAdvertisementUI