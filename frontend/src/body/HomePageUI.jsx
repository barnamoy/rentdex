    ...
    return <div >
      <div class="container w-10" >
        <div class="form-group my-3" >
          ...
          <div class="col mr-5 ">
          <input onChange={this.handleChange} class="form-control col" id="exampleInputEmail1" placeholder="Search" />
          </div>
          <div class="col-1 " style={{marginLeft:'5rem'}}> 
          <button className="btn btn-primary float-right" onClick={this.postAdvertisement} style={{width :'200px' }}>Post your Advertisement</button>
